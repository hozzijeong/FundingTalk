...
public class future_second_desc_fragment extends Main_BaseFragment implements OnMapReadyCallback {
...
//        progressbar = (ImageView) v.findViewById(R.id.progress_bar);
        ...
        setpro_month("12개월");
        setpro_money("0.65억");
        seting_percent("오픈예정 (20.10.03)");
        setpro_first_input("만기일시상환");
        setpro_second_input("가계자금");
        setpro_third_input("근저당권");
        setpro_fourth_input("134.99 (약 40.83평)");
        setpro_fifth_input("74.71%");
        setpro_gamjung_input("44,000만원");
        setdesc("감정가는 KB부동산시세외 일반거래가 44,000만원 및 국토교통부\n 최근실거래가(최근6개월)의 변화 추이동을 반영하여 적용되었습니다.");
        setloan_info_input("2억7,300만원 (원금)");
...
//    public void setprogressbar(){ progressbar.setVisibility(View.INVISIBLE); }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(
                new LatLng(37.6835989,126.7198312)   // 위도, 경도
        ));
        ...
        marker .position(new LatLng(37.6835989,126.7198312))
                .title("꿈에그린아파트")
                .snippet("경기도 고양시 일산서구 가좌동 가좌마을7단지 꿈에그린아파트");
